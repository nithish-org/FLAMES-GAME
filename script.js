...
function getFLAMESResult(name1, name2) {
    ...
    const flames = ['FRIENDS LIKE "DEVA & SURIYA"', 'LOVE LIKE "VIJAY & JULIET"', 'AFFECTION "TYPE OF LOVE AND KINDNESS"', 'MARRIAGE "RIP"', 'ENEMIES LIKE "TOM & JERRY"', 'SISTER LIKE "UNIVERSE"'];
